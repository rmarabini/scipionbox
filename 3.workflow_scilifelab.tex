...
Unfortunately, the K2 [** Jose Miguel, what is K2?, the computer described in the previous paragraph?] computer writes data to a local SSD RAID while the Falcon-III does it to a dedicated storage server (the offload server). %, in order to avoid interruption of data collection due to network issues. 
