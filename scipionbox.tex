...
\lyxaddress{{\small$^{(f)}$ MRC Laboratory of Molecular Biology - Structural studies, Cambridge, England, United Kingdom}}
...
\textbf{Corresponding Author: Roberto Marabini, Ph = +34 91 5854510, email: roberto@cnb.csic.es\\} %Roberto Marabini, Ph= 34 91 5854510, email: roberto@cnb.csic.es\\
