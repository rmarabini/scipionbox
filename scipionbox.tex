...
%\lyxaddress{{\small$^{(14)}$Massachusetts Institute of Technology, USA}}
% 
% \lyxaddress{{\small \vspace{-0.5cm}$^{(3)}$Bioengineering Lab., Universidad CEU San Pablo, Campus Urb.
% Montepríncipe s/n, 28668 Boadilla del Monte, Madrid, Spain.}}
% 
